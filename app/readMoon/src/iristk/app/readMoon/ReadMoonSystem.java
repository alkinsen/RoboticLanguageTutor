...
public class ReadMoonSystem {

	public ReadMoonSystem() throws Exception {
		// Create the system
		...
		// Add the flow
		system.addModule(new FlowModule(new ReadMoonFlow()));
		
		// Load a grammar in the recognizer
		system.loadContext("default", new SpeechGrammarContext(new SRGSGrammar(system.getPackageFile("ReadMoonGrammar.xml"))));
