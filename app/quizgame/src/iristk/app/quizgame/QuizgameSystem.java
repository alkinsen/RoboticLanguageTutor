...
public class QuizgameSystem {
		
	public QuizgameSystem() throws Exception {
		...
		system.connectToBroker("furhat", "172.20.88.124");
		//system.setupFace(new WindowsSynthesizer(), Gender.FEMALE);
		
		system.addModule(new FlowModule(new QuizgameFlow(systemAgentFlow)));
		system.loadContext("default", new SpeechGrammarContext(new SRGSGrammar(system.getPackageFile("QuizgameGrammar.xml"))));
