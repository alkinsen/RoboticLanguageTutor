...
public class ReadBearSystem {

	public ReadBearSystem() throws Exception {
		// Create the system
		...
		// Add the flow
		system.addModule(new FlowModule(new ReadBearFlow()));
		
		// Load a grammar in the recognizer
		system.loadContext("default", new SpeechGrammarContext(new SRGSGrammar(system.getPackageFile("ReadBearGrammar.xml"))));
